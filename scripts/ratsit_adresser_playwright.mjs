...
async function saveAddressData(
    ...
    try {
        ...
        const { stdout, stderr } = await execAsync(
            `cd ${projectRoot} && php artisan tinker --execute="\\App\\Models\\RatsitAdresserSverige::create(['post_ort' => '${postOrt}', 'post_nummer' => '${postNummer}', 'gatuadress_namn' => '${gatuadressNamn}', 'gatuadress_count' => ${gatuadressCount}, 'gatuadress_nummer_link' => '${gatuadressNummerLink}']); echo 'Saved address: ${gatuadressNamn}, ${postNummer} ${postOrt}';"`,
        );
