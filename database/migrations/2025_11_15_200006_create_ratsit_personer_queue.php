...
return new class extends Migration
{
    ...
    {
        Schema::create('ratsit_personer_queue', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedInteger('personer_page')->default(0); // total pages detected
            $table->unsignedInteger('personer_pages')->default(0);  // current/last processed page
    ...
    {
        Schema::dropIfExists('ratsit_personer_queue');
    }
};
