...
return new class extends Migration
{
    ...
    {
        // Create hitta_alla table (copy of hitta_se)
        Schema::create('hitta_alla', function (Blueprint $table) {
            $table->id();
        ...
        // Create hitta_data table (copy of hitta_se)
        Schema::create('hitta_data', function (Blueprint $table) {
            $table->id();
            $table->text('personnamn')->nullable();
            $table->text('alder')->nullable();
            $table->text('kon')->nullable();
    ...
    {
        Schema::dropIfExists('hitta_alla');
        Schema::dropIfExists('hitta_data');
    }
};
