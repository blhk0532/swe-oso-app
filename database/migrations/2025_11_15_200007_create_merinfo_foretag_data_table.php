...
return new class extends Migration
{
    ...
    {
        Schema::create('merinfo_foretag_data', function (Blueprint $table) {
            $table->id();
            $table->text('foretagsnamn')->nullable();
            $table->text('orgnummer')->nullable();
    ...
    {
        Schema::dropIfExists('merinfo_foretag_data');
    }
};
