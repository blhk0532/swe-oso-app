...
/**
 * @extends \Illuminate\Database\Eloquent\Factories\Factory<\App\Models\HittaQueue>
 */
class HittaQueueFactory extends Factory
{
    /**
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            // Use only enum values allowed by migration: pending, running, complete, empty, resume, idle, failed
    ...
    /**
     * Indicate that personer are queued.
     */
    public function personerQueued(): static
    {
        return $this->state(fn (array $attributes) => [
    ...
    /**
     * Indicate that foretag are queued.
     */
    public function foretagQueued(): static
    {
        return $this->state(fn (array $attributes) => [
            'foretag_queued' => true,
        ]);
