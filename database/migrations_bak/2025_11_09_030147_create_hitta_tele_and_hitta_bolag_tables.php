...
return new class extends Migration
{
    ...
    {
        // Create hitta_tele table (copy of hitta_se)
        Schema::create('hitta_tele', function (Blueprint $table) {
            $table->id();
        ...
        // Create hitta_bolag table (copy of hitta_se)
        Schema::create('hitta_bolag', function (Blueprint $table) {
            $table->id();
            $table->text('personnamn')->nullable();
            $table->text('alder')->nullable();
            $table->text('kon')->nullable();
    ...
    {
        Schema::dropIfExists('hitta_tele');
        Schema::dropIfExists('hitta_bolag');
    }
};
